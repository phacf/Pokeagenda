...
import { Container, PokePhoto, Pdex, Pball,Screen } from "./style";
const Pokedex = ({ pokemon, pokeId, setPokeId }) => {
  ...
  return (
    <Container>
      <Pdex src={agenda} />
      <Screen>
      <PokePhoto src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemon.id}.png`}/>
      <Pball src={ball} />
      </Screen>
